        ...
        <x-splade-data default="{show: false}">
            <div class="grid grid-cols-2 gap-4">
                @foreach($themes as $theme)
                    <div>
                        <div class="border border-gray-300 bg-center bg-cover w-full h-60" style="background-image: url('{{theme_assets('images/'. $theme['info']->placeholder)}}')"></div>
                        @if(setting('theme_name') === $theme['info']->alias)
